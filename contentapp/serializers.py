...
class UserStoryTitleSerializer(serializers.ModelSerializer):
	...
	class Meta:
		...
		fields = ('id','title', 'short_description','search_by','default_image','title_choice','created_at','overall_rating','total_reviewer','five_star_avg','four_star_avg','three_star_avg','two_star_avg','one_star_avg')
...
class UserBlogTitleSerializer(serializers.ModelSerializer):
	...
	class Meta:
		model = UserBlogTitle
		fields = ('id','title', 'short_description','search_by','default_image','title_choice','created_at')
...
class UserPoemSerializer(serializers.ModelSerializer):
	...
	class Meta:
		model = UserPoem
		fields = ('id','title', 'short_description','search_by','default_image','title_choice','overall_rating','total_reviewer','five_star_avg','four_star_avg','three_star_avg','two_star_avg','one_star_avg')
